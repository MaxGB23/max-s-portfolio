...
export function HeroSection() {
  ...
  return (
    <section
      ...
      className="debug-l1 relative min-h-[85dvh] flex flex-col items-center justify-center pt-22 sm:pt-24 lg:[@media(min-height:700px)]:pt-32 2xl:pt-40 px-6 md:px-8 lg:px-12"
    >
      {/* Background Aurora */}
      <div
