...
export function FeaturedProjectPanel({ project, children, overlay }: FeaturedProjectPanelProps) {
  ...
  return (
    <article
      className="debug-l4 featured-panel relative flex items-center portrait:lg:mb-24 landscape:lg:[@media(max-height:767px)]:mb-24 landscape:lg:[@media(max-height:767px)]:last:mb-0 w-full px-6 md:px-8 lg:px-12"
