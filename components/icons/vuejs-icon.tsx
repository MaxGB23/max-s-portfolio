...
export function VueJsIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 -17.5 256 256" preserveAspectRatio="xMinYMin meet" xmlns="http://www.w3.org/2000/svg" {...props}>
