...
| Card → card | `portrait:lg:mb-24 landscape:lg:[@media(max-height:767px)]:mb-24` en el `article` | **96px** portrait lg · **96px** landscape lg corto (≤767px, sin pin) · 0 dentro del gate |
